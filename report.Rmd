...
fig <- fig %>% add_lines(y = ~values[,1], name = 'CAR T eff', type = 'scatter', mode = 'lines', line = list(color = 'blue', width=2))
fig <- fig %>% add_lines(y = ~values[,2], name = 'CAR T mem', type = 'scatter', mode = 'lines', line = list(color = 'forestgreen', width=2))
